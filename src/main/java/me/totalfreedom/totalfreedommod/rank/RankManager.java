...
public class RankManager extends FreedomService
{
    ...
    public Displayable getDisplay(CommandSender sender)
    {
        ...
        if (ConfigEntry.SERVER_CO_OWNERS.getList().contains(player.getName()))
        {
            return Title.CO_OWNER;
        }
        
        // If the player's a staff-manager, display that
        if (ConfigEntry.SERVER_STAFF_MANAGERS.getList().contains(player.getName()))
        {
            return Title.STAFF_MANAGER;
        }
        ...
        // If the player's a lead-developer, display that
        if (ConfigEntry.SERVER_LEAD_DEVELOPERS.getList().contains(player.getName()))
        {
            return Title.LEAD_DEVELOPER;
        }
        
        // If the player's a plugin-developer, display that
        if (ConfigEntry.SERVER_PLUGIN_DEVELOPERS.getList().contains(player.getName()))
        {
            return Title.PLUGIN_DEVELOPER;
        }
        
        
        // If the player's a system-admin, display that
        ...
        // If the player's a dank M1CE, display that
        if (ConfigEntry.SERVER_M1CE.getList().contains(player.getName()))
        {
            return Title.M1CE;
        }
