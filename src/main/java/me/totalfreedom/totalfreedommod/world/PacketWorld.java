...
public final class PacketWorld extends CustomWorld

{
...

    {
        ...
        welcomeSign.setLine(0, ChatColor.GREEN + "PacketWorld");
...

    {
...

        {
            ...
            FLog.info(player.getName() + " attempted to access the PacketWorld.");
