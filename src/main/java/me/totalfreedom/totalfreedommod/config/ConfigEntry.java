...
public enum ConfigEntry
{
    ...
    SERVER_CO_OWNERS(List.class, "server.co-owners"),
    SERVER_STAFF_MANAGERS(List.class, "server.staff-managers"),
    ...
    SERVER_BTIN_SQUAD(List.class, "server.btinsquad"),
    SERVER_XBARK_SQUAD(List.class, "server.xbarksquad"),
